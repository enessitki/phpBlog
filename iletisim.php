...
<?php require_once 'admin/pages/inc-fonksiyonlar.php';
...
<body>
  ...
  <!-- Page Header -->
  <header class="masthead" style="background-image: url('img/iletisim.jpg')">
      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="page-heading">
            <h1>İletişim</h1>
            <span class="subheading">İletişime geçiniz.</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 col-md-10 mx-auto">
        <p>Lütfen formu doğru bir şekilde doldurunuz.</p>
        ...
        <form action="iletisim.php#bildiri" method="POST" >
          <div class="control-group">
            <div class="form-group floating-label-form-group controls">
              ...
              <input type="text" class="form-control" placeholder="Ad Soyad" name="name" required data-validation-required-message="Adınızı Giriniz!">
          ...
          <div class="control-group">
            <div class="form-group col-xs-12 floating-label-form-group controls">
              <label>Telefon</label>
              <input type="tel" class="form-control" placeholder="Telefon" name="phone" required data-validation-required-message=" Telefon Numaranızı Giriniz!">
              <p class="help-block text-danger"></p>
            </div>
          </div>
          <div class="control-group">

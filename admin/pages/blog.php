                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            if(@$_GET["i"]=="ekle"){
                                ...
                                echo "<span class='text-danger'>İşlem Başarısız!</span>";
                            }
                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php
                                    $cek=$db->prepare("SELECT * FROM `blog` ORDER BY `id`DESC");//KAYITLARI SIRALIYOR
                                    $cek->execute();
                                    ...
                                    ?>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                            <?php if($row["aktif"]==1){?>
                                                <a href="blog.php?is=aktif&id=<?=$row["id"]?>&durum=<?=$row["aktif"]?>"onclick="return confirm('Aktiflik Durumu Değişsin Mi?')" 

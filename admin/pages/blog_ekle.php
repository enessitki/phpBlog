...
if(@$_POST["submit"]){
    ...
    $blog_ekle =$db->prepare("INSERT INTO `blog` (`baslik`,`alt_baslik`,`aciklama`,`aktif`)VALUES
    (:baslik,:alt_baslik,:aciklama,:aktif)");
    $blog_ekle->bindValue(":baslik",$baslik,PDO::PARAM_STR);
    $blog_ekle->bindValue(":alt_baslik",$alt_baslik,PDO::PARAM_STR);
    $blog_ekle->bindValue(":aciklama",$aciklama,PDO::PARAM_STR);
    $blog_ekle->bindValue(":aktif",$aktif,PDO::PARAM_INT);
    if($blog_ekle->execute()){
